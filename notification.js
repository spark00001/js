...
<input style='border:2ox solid gold;color:white;background-color:transparent;outline:3px solid white;width:99%;height:45px;' id='usrquerry' onclick='universalsearch()' type='button' placeholder='Search for more...'>
`;  
...
function cl(){
document.getElementById("findcontent").innerHTML="<input style='border:2ox solid gold;color:white;background-color:transparent;outline:3px solid white;width:99%;height:45px;' id='usrquerry' onclick='universalsearch()' type='button' placeholder='Search for more...'>";
