...
function finding(){
document.getElementById("searchfinder").innerHTML="<input style='border:2px solid gold;background-color:;color:;width:70%;height:40px;border-radius:20px;' type='search'id='find' onkeypress='findout()' placeholder='   search'>";
