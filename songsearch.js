    ...
    function spark(){
      location.reload();
        ...
        if(takesong.toLowerCase() == "bodyguard"){
            document.getElementById("audio").innerHTML="<div id='song' id='terimeripremkahani'><table><tr><td><p id='titleimg' onclick='terimeripremkahani()'><img src='https://i1.sndcdn.com/artworks-000105449528-hgc39r-t500x500.jpg' class='music'></p></td><td><p id='mtitle' onclick='terimeripremkahani()'>TERI MERI PREM KAHANI</p></td><td><p id='terimeripremkahani_button'></p></td></tr></table></div> <br>                                                                                                                       <div id='song'><table><tr><td><p id='titleimg' onclick='bodyguard_title()'><img src='https://i1.sndcdn.com/artworks-000105449528-hgc39r-t500x500.jpg' class='music'></p></td><td><p id='mtitle' onclick='bodyguard_title()'>BODYGUARD TITLE</p></td><td><p id='terimeripremkahan_button'></p></td></tr></table></div> <BR>                                                                                                                                                   <div id='song'><table><tr><td><p id='titleimg' onclick='bodyguard_iloveyou()'><img src='https://i1.sndcdn.com/artworks-000105449528-hgc39r-t500x500.jpg' class='music'></p></td><td><p id='mtitle' onclick='bodyguard_iloveyou()'>I LOVE YOU</p></td><td><p id='terimeripremkahan_button'></p></td></tr></table></div>";
        }
        document.getElementById("mainhub").style.display="none";
        }
